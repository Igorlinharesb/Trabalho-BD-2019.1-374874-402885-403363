...
public class Museu {
    ...
    public static void main(String[] args) {
        ...
        final String SELECT_QUERY ="SELECT * FROM Museu as m inner join Ponto_Turistico as pt on m.PT_ID = pt.ID_PT  " ;
       
/*Hotel as h inner join Casa_de_Show as cs on h.Restaurante_ID = cs.Restaurante_ID */
...
// obtém os metadados de ResultSet
        ...
        System.out.printf("Tabela de Museus:%n%n");
