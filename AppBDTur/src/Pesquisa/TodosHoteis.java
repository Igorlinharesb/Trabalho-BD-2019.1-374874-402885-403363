...
public class TodosHoteis {
    ...
    public static void main(String[] args) {
        ...
        final String SELECT_QUERY ="SELECT ID_Hotel, Nome_Hotel , Categoria, Cidade_ID, Restaurante_ID FROM Hotel";
...
// obtém os metadados de ResultSet
        ...
        System.out.printf("Tabela de Hotéis:%n%n");
