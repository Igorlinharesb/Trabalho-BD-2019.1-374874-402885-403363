 ...
 * @author hital
 */
public class PontoTuristicoDescricao {
    ...
    public static void main(String[] args) {
        ...
        final String SELECT_QUERY ="SELECT ID_PT, Descricao, Cidade_ID, Nome FROM Ponto_Turistico" ;
...
// obtém os metadados de ResultSet
        ...
        System.out.printf("Tabela de Pontos Turísticos:%n%n");
