 ...
 * @author hital
 */
public class PontosTuristicosde1Cidade {
    ...
    public static void main(String[] args) {
        ...
        final String SELECT_QUERY ="SELECT * FROM Cidade as c inner join Ponto_Turistico as pt on c.ID_Cidade = pt.Cidade_ID && c.ID_Cidade like 1 " ;
...
// obtém os metadados de ResultSet
        ...
        System.out.printf("Tabela de Pontos Turísticos pertecente a uma cidade :%n%n");
...
} // fim da classe PontoTuristicoDescricao
