...
public class DadosIgreja {
    ...
    public static void main(String[] args) {
        ...
        final String SELECT_QUERY ="SELECT * FROM Igreja as i inner join Ponto_Turistico as pt on i.PT_ID = pt.ID_PT  " ;
...
// obtém os metadados de ResultSet
        ...
        System.out.printf("Tabela de Igrejas:%n%n");
